      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            CustomSizedBox(
              height: width / 8 - 50, verticalEdge: 0.0, child: CarouselSlider(
              items: [
                Center(
                  child: Row(
                    children: [
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              customElevatedButton(onTap: (){}, title: "Contact Me"),
                              SizedBox(width: 8.0),
                              customElevatedButton(onTap: (){}, title: "Download my resume")
                            ],
                          ),
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              serviceCard(width: width, title: "UI/UX Design", image: "assets/images/download.jpeg"),

                              serviceCard(width: width, title: "App Design", image: "assets/images/what-is-flutter.png"),

                              serviceCard(width: width, title: "App Development", image: "assets/images/download.jpeg")
                            ],
                          ),

                          SizedBox(height: 20.0),

                          customElevatedButton(onTap: (){}, title: "See All")
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              portfolioCard(width: width, image: "assets/images/download.jpeg"),

                              portfolioCard(width: width, image: "assets/images/what-is-flutter.png")
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text('Get the latest information', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
